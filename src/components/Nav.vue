...
<template>
    <nav class="fixed z-20 min-w-[320px] w-full bg-white/90 h-[50px] sm:h-[60px] md:h-[70px] lg:h-[80px] xl:h-[90px] shadow-md lg:shadow-lg xl:shadow-xl flex justify-end md:justify-center items-center pe-5">
        <AnOutlinedMenu class="md:hidden text-xl sm:text-2xl cursor-pointer" v-if="!show" @click="showToogle()"></AnOutlinedMenu>
